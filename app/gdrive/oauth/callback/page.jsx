  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center h-screen">
        <h1 className="text-3xl font-bold text-gray-700">GDrive</h1>
        <p className="text-gray-500 text-sm">OAuth Callback</p>
        {loading ? (
          ...
          <div className="flex flex-col justify-center items-center">
            {success && <p className="text-green-500 text-sm">{message}</p>}
            {!success && <p className="text-red-500 text-sm">{message}</p>}
          </div>
        )}
      </div>
    </>
