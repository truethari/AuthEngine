        ...
        <form>
          <div className="grid w-full items-center gap-4">
            ...
            <ul>
              ...
              <li>
                3. Click on the "Create Credentials" button and select "OAuth client ID" from the
                dropdown menu.
              </li>
              ...
              <li>6. Click on the "Create" button to generate the client ID and client secret.</li>
              <li>
            ...
            <ul>
              ...
              <li>
                4. Under the "OAuth consent screen" tab, you can configure the OAuth scopes required
                by your application.
              </li>
              <li>5. Click on the "Add or Remove Scopes" button to select the desired scopes.</li>
